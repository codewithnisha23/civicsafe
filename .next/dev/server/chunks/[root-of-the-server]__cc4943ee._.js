...
async function POST(request) {
    try {
        ...
        // ✅ update report
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("reports").update({
            status: status
        }).eq("id", id).select();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc4943ee._.js.map
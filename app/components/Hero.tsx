export default function Hero() {
    return (
        <section className="py-32 px-6 text-center">
            ...
            {/* Main Heading */}
            <h1 className="text-6xl font-bold text-gray-900 mt-8 leading-tight">
            ...
            <div className="mt-10 flex justify-center gap-4">
                ...
                {/* Primary Button */}
                <button className="bg-blue-700 hover:bg-blue-800 text-white px-8 py-3 rounded-lg font-medium transition">
                    Report a Case
                </button>

                {/* Secondary Button */}
                <button className="border border-gray-300 hover:bg-gray-100 text-gray-800 px-8 py-3 rounded-lg font-medium transition">
                    View Dashboard
                </button>
